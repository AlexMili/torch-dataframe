...
- [torchnet](#__torchnet__)
- [tnt.utils.table.clone(table)](#utils.table.clone)
- [tnt.utils.table.merge(dst, src)](#utils.table.merge)
- [tnt.utils.table.foreach(tbl, closure[, recursive])](#utils.table.foreach)
- [tnt.utils.table.canmergetensor(tbl)](#utils.table.canmergetensor)
- [tnt.utils.table.mergetensor(tbl)](#utils.table.mergetensor)
- [transform.identity(...)](#transform.identity)
- [tnt.ListDataset(self, list, load[, path])](#ListDataset)
- [tnt.IndexedDataset(self, fields[, path][, maxload][, mmap][, mmapidx])](#IndexedDataset)
- [tnt.IndexedDatasetWriter(self, indexfilename, datafilename, type)](#IndexedDatasetWriter)
- [tnt.IndexedDatasetWriter.add(self, tensor)](#IndexedDatasetWriter.add)
- [tnt.IndexedDatasetReader(self, indexfilename, datafilename[, mmap][, mmapidx])](#IndexedDatasetReader)
- [tnt.IndexedDatasetReader.size(self)](#IndexedDatasetReader.size)
- [tnt.IndexedDatasetReader.get(self, index)](#IndexedDatasetReader.get)
- [tnt.TransformDataset(self, dataset, transform[, key])](#TransformDataset)
- [tnt.TransformDataset(self, dataset, transforms)](#TransformDataset)
- [tnt.BatchDataset(self, dataset, batchsize[, perm][, merge][, policy])](#BatchDataset)
- [tnt.CoroutineBatchDataset(self, dataset, batchsize[, perm][, merge][, policy])](#CoroutineBatchDataset)
- [tnt.ConcatDataset(self, datasets)](#ConcatDataset)
- [tnt.ResampleDataset(self, dataset[, sampler][, size])](#ResampleDataset)
- [tnt.ShuffleDataset(self, dataset[, size][, replacement])](#ShuffleDataset)
- [tnt.ShuffleDataset.resample(self)](#ShuffleDataset.resample)
- [tnt.SplitDataset(self, dataset, partitions)](#SplitDataset)
- [tnt.SplitDataset.select(self, partition)](#SplitDataset.select)
- [tnt.DatasetIterator(self, dataset[, perm][, filter][, transform])](#DatasetIterator)
- [tnt.DatasetIterator.exec(tnt.DatasetIterator, name, ...)](#DatasetIterator.exec)
- [tnt.ParallelDatasetIterator(self[, init], closure, nthread[, perm][, filter][, transform][, ordered])](#ParallelDatasetIterator)
- [tnt.ParallelDatasetIterator.execSingle(tnt.DatasetIterator, name, ...)](#ParallelDatasetIterator.execSingle)
- [tnt.ParallelDatasetIterator.exec(tnt.DatasetIterator, name, ...)](#ParallelDatasetIterator.exec)
- [tnt.APMeter(self)](#APMeter)
- [tnt.AverageValueMeter(self)](#AverageValueMeter)
- [tnt.AUCMeter(self)](#AUCMeter)
- [tnt.ConfusionMeter(self, k[, normalized])](#ConfusionMeter)
- [tnt.mAPMeter(self)](#mAPMeter)
- [tnt.MultiLabelConfusionMeter(self, k[, normalized])](#MultiLabelConfusionMeter)
- [tnt.ClassErrorMeter(self[, topk][, accuracy])](#ClassErrorMeter)
- [tnt.TimeMeter(self[, unit])](#TimeMeter)
- [tnt.PrecisionAtKMeter(self[, topk][, dim][, online])](#PrecisionAtKMeter)
- [tnt.RecallMeter(self[, threshold][, perclass])](#RecallMeter)
- [tnt.PrecisionMeter(self[, threshold][, perclass])](#PrecisionMeter)
- [tnt.NDCGMeter(self[, K])](#NDCGMeter)
- [tnt.Log(self, keys[, onClose][, onFlush][, onGet][, onSet])](#Log)
- [tnt.Log:status(self[, message][, time])](#Log.status)
- [tnt.Log:set(self, keys)](#Log.set)
- [tnt.Log:get(self, key)](#Log.get)
- [tnt.Log:flush(self)](#Log.flush)
- [tnt.Log:close(self)](#Log.close)
- [tnt.Log:attach(self, event, closures)](#Log.attach)
- [tnt.RemoteLog(self, keys[, server][, name][, onClose][, onFlush][, onGet][, onSet])](#RemoteLog)
